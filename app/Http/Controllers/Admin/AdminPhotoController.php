...
class AdminPhotoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            ->editColumn('photo_url', function ($data) {
                $photo_url = $this->GetImage($file_name = $data->photo_url,$path=config('global.file_path.photo_url'));
    ...
    public function photo_data_edit($id)
    {
        ...
        $photoData->photo_url = $this->GetImage($file_name = $photoData->photo_url,$path=config('global.file_path.photo_url'));
