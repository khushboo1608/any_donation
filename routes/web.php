...
use App\Http\Controllers\Admin\AdminServiceNeedsController;
use App\Http\Controllers\Admin\AdminSpecificNeedsController;
    ...
    Route::middleware('is_admin')->group( function () { 
       ...
       Route::post('setting/savegeneral',[AdminSettingController::class,'SaveGeneral'])->name('setting.savegeneral');
        ...
        Route::get('subadminfile-export',   [SubAdminController::class, 'subadminfileexport'])->name('subadminfile-export');  
         ...
         //Service Needs
         Route::get('/serviceneeds',                       [AdminServiceNeedsController::class, 'index'])->name('admin.serviceneeds');
         Route::get('/add_serviceneeds',[AdminServiceNeedsController::class,'add_serviceneeds']);
         Route::post('serviceneeds/saveserviceneeds',[AdminServiceNeedsController::class,'saveserviceneeds'])->name('serviceneeds.saveserviceneeds');
         Route::post('/serviceneeds_delete',               [AdminServiceNeedsController::class, 'serviceneeds_delete'])->name('admin.delete-serviceneeds');
         Route::get('serviceneeds/edit/{id}',   [AdminServiceNeedsController::class, 'serviceneeds_data_edit'])->name('serviceneedsdataedit');
        //  Route::get('serviceneedsfile-export',   [AdminServiceNeedsController::class, 'serviceneedsfileexport'])->name('serviceneedsfile-export');   
         Route::post('/serviceneeds_status',  [AdminServiceNeedsController::class, 'serviceneeds_status'])->name('admin.serviceneeds_status'); 
         Route::post('/service_multi_status',  [AdminServiceNeedsController::class, 'service_multi_status'])->name('admin.service_multi_status');        
         
    
         //Specific Needs
         Route::get('/specificneeds',                       [AdminSpecificNeedsController::class, 'index'])->name('admin.specificneeds');
         Route::get('/add_specificneeds',[AdminSpecificNeedsController::class,'add_specificneeds']);
         Route::post('specificneeds/savespecificneeds',[AdminSpecificNeedsController::class,'savespecificneeds'])->name('specificneeds.savespecificneeds');
         Route::post('/specificneeds_delete',               [AdminSpecificNeedsController::class, 'specificneeds_delete'])->name('admin.delete-specificneeds');
         Route::get('specificneeds/edit/{id}',   [AdminSpecificNeedsController::class, 'specificneeds_data_edit'])->name('specificneedsdataedit');
        //  Route::get('specificneedsfile-export',   [AdminSpecificNeedsController::class, 'specificneedsfileexport'])->name('specificneedsfile-export');   
         Route::post('/specificneeds_status',  [AdminSpecificNeedsController::class, 'specificneeds_status'])->name('admin.specificneeds_status'); 
         Route::post('/specificneeds_multi_status',  [AdminSpecificNeedsController::class, 'specificneeds_multi_status'])->name('admin.specificneeds_multi_status');  
    });
});