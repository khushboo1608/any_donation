          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="col-md-5 col-xs-12">
                <h3 class="card-title">Edit Eye Donations</h3>
              </div>
            ...
            @endif
              <input type="hidden" name="eyedonation_id" id="eyedonation_id" value="{{$eyeData->eyedonation_id}}">   
                <div class="card-body">
                  
                <div class="form-group row">
                    <label for="eyedonation_title" class="col-sm-2 col-form-label"> Title :-</label>
                    <div class="col-sm-6">
                      <input type="Text" class="form-control" id="eyedonation_title" name="eyedonation_title" placeholder="Eye Donation title" required="true" value="{{$eyeData->eyedonation_title}}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <select name="eyedonation_type" id="eyedonation_type"  class="form-control" required="true">
                        ...
                        <option value="Orphange1" {{ $eyeData->eyedonation_type == 'Orphange1' ? 'selected' : '' }}>Orphange1</option>
                        <option value="Orphange2" {{ $eyeData->eyedonation_type == 'Orphange2' ? 'selected' : '' }}>Orphange2</option>
                        <option value="Orphange3" {{ $eyeData->eyedonation_type == 'Orphange3' ? 'selected' : '' }}>Orphange3</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="Text" class="form-control" id="eyedonation_purpose" name="eyedonation_purpose" placeholder="Eye Donation Purpose" required="true" value="{{$eyeData->eyedonation_purpose}}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="Text" class="form-control" id="eyedonation_achievement" name="eyedonation_achievement" placeholder="Eye Donation Achievement" required="true" value="{{$eyeData->eyedonation_achievement}}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="Text" class="form-control" id="eyedonation_started_in" name="eyedonation_started_in" placeholder="Eye Donation Started In" required="true" value="{{$eyeData->eyedonation_started_in}}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="Text" class="form-control" id="eyedonation_size" name="eyedonation_size" placeholder="Eye Donation Purpose" required="true" value="{{$eyeData->eyedonation_size}}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <select name="service_needs_id" id="service_needs_id"  class="form-control" required="true">
                        ...
                        @php $selected = explode(",", $eyeData['service_needs_id']);
                        @endphp
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <select name="specific_needs_id" id="specific_needs_id"  class="form-control" required="true">
                        ...
                        @php $selected = explode(",", $eyeData['specific_needs_id']);
                        @endphp
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="Text" class="form-control" id="eyedonation_number" name="eyedonation_number" placeholder="Eye Donation Number" required="true" value="{{$eyeData->eyedonation_number}}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="Text" class="form-control" id="eyedonation_email" name="eyedonation_email" placeholder="Eye Donation Email" required="true" value="{{$eyeData->eyedonation_email}}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      <input type="text"  name="eyedonation_address" id="address" value="{{$eyeData->eyedonation_address}}" class="form-control" required>
                      <div id="map" style="display: none"></div>
                            <input type="hidden" name="eyedonation_lat" id="latitude" value="{{$eyeData->eyedonation_lat}}">
                            <input type="hidden" name="eyedonation_long" id="longitude" value="{{$eyeData->eyedonation_long}}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <select name="state_id" id="state_id"  class="form-control" required="true">
                        ...
                        @php $selected = explode(",", $eyeData['state_id']);
                        @endphp
                    ...
                    <div class="col-sm-6">
                      <select name="city_id" id="city_id"  class="form-control" required="true">
                        @foreach ($cityData['city'] as $item)
                          @php $selected = explode(",", $eyeData['city_id']);
                          @endphp
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <div class="fileupload_block">
                        <input name="eyedonation_image"  type="file" value="fileupload" id="fileupload"  accept="image/png, image/jpeg, image/jpg">
                        <!-- <div class="fileupload_img"><img type="image" src="{{asset('admin_assets/images/add-image.png')}}"  /></div> -->
                        @if(isset($eyeData) && isset($eyeData->eyedonation_image))
                              @if($eyeData->eyedonation_image !='')
                            <div class="fileupload_img"><img type="image" src="{{$eyeData->eyedonation_image}}" style="height: 80px;width: 80px;margin-left: 20px;"  /></div>
                            @else
                            <div class="fileupload_img"><img type="image" src="{{asset('admin_assets/images/add-image.png')}}" /></div>
                            @endif
                          @endif
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="Text" class="form-control" id="eyedonation_history" name="eyedonation_history" placeholder="Eye Donation History" required="true" value="{{$eyeData->eyedonation_history}}">
                    </div>
                  </div>
