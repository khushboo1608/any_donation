      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            @endif
              <input type="hidden" name="photo_id" id="photo_id" value="{{$photoData->photo_id}}">   
                <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <select name="photo_type" id="photo_type"  class="form-control" >
                        ...
                        <option value="3" {{ $photoData->photo_type == '3' ? 'selected' : '' }}>NGO</option>
                        <option value="4" {{ $photoData->photo_type == '4' ? 'selected' : '' }}>Blood Bank</option>
                      </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <select name="user_id" id="user_id"  class="form-control" required="true">
                        @foreach ($userData['user'] as $item)
                          @php $selected = explode(",", $photoData['user_id']);
                          @endphp
                  ...
                  <div class="form-group row">
                    <label for="photo_name" class="col-sm-2 col-form-label">Photo Name :-</label>
                    <div class="col-sm-6">
                      <input type="Text" class="form-control" id="photo_name" name="photo_name" placeholder="Banner Name" required="true" value="{{$photoData->photo_name}}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <div class="fileupload_block">
                        <input name="photo_url"  type="file" value="fileupload" id="fileupload"  accept="image/png, image/jpeg, image/jpg">
                        <!-- <div class="fileupload_img"><img type="image" src="{{asset('admin_assets/images/add-image.png')}}"  /></div> -->
                        @if(isset($photoData) && isset($photoData->photo_url))
                              @if($photoData->photo_url !='')
                            <div class="fileupload_img"><img type="image" src="{{$photoData->photo_url}}" style="height: 80px;width: 80px;margin-left: 20px;"  /></div>
                            @else
                            <div class="fileupload_img"><img type="image" src="{{asset('admin_assets/images/add-image.png')}}" /></div>
                            @endif
                          @endif
