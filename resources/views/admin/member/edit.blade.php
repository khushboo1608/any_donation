      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            @endif
              <input type="hidden" name="member_details_id" id="member_details_id" value="{{$memberData->member_details_id}}">   
                <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <select name="user_id" id="user_id"  class="form-control" required="true">
                        @foreach ($userData['user'] as $item)
                          @php $selected = explode(",", $memberData['user_id']);
                          @endphp
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="Text" class="form-control" id="member_name" name="member_name" placeholder="Member Name" required="true" value="{{$memberData->member_name}}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <div class="fileupload_block">
                        <input name="member_image"  type="file" value="fileupload" id="fileupload"  accept="image/png, image/jpeg, image/jpg">
                        <!-- <div class="fileupload_img"><img type="image" src="{{asset('admin_assets/images/add-image.png')}}"  /></div> -->
                        @if(isset($memberData) && isset($memberData->member_image))
                              @if($memberData->member_image !='')
                            <div class="fileupload_img"><img type="image" src="{{$memberData->member_image}}" style="height: 80px;width: 80px;margin-left: 20px;"  /></div>
                            @else
                            <div class="fileupload_img"><img type="image" src="{{asset('admin_assets/images/add-image.png')}}" /></div>
                            @endif
                          @endif
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="Text" class="form-control" id="member_phone_number" name="member_phone_number" placeholder="Member Number" required="true" value="{{$memberData->member_phone_number}}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="Text" class="form-control" id="member_position" name="member_position" placeholder="Member Position" required="true" value="{{$memberData->member_position}}">
                    </div>
                  </div>
