              ...
              <input type="hidden" name="id" id="id" value="">   
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      <select name="login_type" id="login_type" class="form-control select2 filter" required="true" >
                      <option selected="true" value="" disabled="disabled">Choose Sub Admin Type</option>
                         <option value="3">District Admin</option>
                         <option value="4">Taluka Admin</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <select name="state_id" id="state_id" class="form-control select2 filter" required="true">
                          <option selected="true" value="" disabled="disabled">Choose State</option>   
