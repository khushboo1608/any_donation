...
<footer class="footer__section footer__bg">
    <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer__widget logo-data">
                        <div class="footer__widget--inner">
                            ...
                            <p class="footer__widget--desc">Lorem ipsum dolor sit amet, <br> consectetur adipiscing elit, <br>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer__widget">
                        ...
                        <!-- <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{ url('testimonialList') }}">Testimonial</a></li> -->
                            ...
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{ url('codpolicy') }}">COD Policy</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{ url('shippingpolicy') }}">Shipping Policy</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{ url('termsandconditions') }}">Terms and Conditions</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{ url('refundexchangepolicy') }}">Refund and Exchanges Policy</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{ url('faq') }}">FAQ’s</a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    @csrf
                        ...
                        <li class="footer__widget--menu__list"><a href="{{route('userlogin')}}" class="footer__widget--menu__text">Login / Register</a></li>
                        @endif
        ...
        <div class="footer__bottom d-flex justify-content-between align-items-center">
            <p class="copyright__content  m-0">Copyright © 2023 <a class="copyright__content--link" href="index.html">ANY</a> . All Rights Reserved.Design By ANY</p>
